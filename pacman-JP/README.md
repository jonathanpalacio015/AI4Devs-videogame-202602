...
Ver [`prompts.md`](./prompts.md) para el **prompt maestro** completo (genera el 100 % de
la aplicación en una sola instrucción) y los 6 prompts de refinamiento que
aplicaron correcciones puntuales sin reescribir el proyecto.
